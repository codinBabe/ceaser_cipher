    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 text-lg">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-8">
          <p className="max-w-2xl">
            ...
            encrypts files online easily for free. Our tools are here to help
      ...
      <section className="mx-auto max-w-6xl flex flex-col items-center justify-center px-4 text-center mt-32">
        ...
        <p className="text-lg max-w-xl">
          ...
          documents for easier emailing, sharing, or storage, you’ll be ready to
          go within seconds.
        </p>
      </section>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          <div>
            ...
            <p className="text-lg max-w-xl">
              ...
              a variety of encryption shifts to suit your needs. Our file
