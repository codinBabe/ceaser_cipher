      ...
      <main>
        ...
        <section className="mx-auto max-w-5xl px-4 text-lg">
          <div className="flex items-start justify-between gap-8">
            <p>
              Encrypt files online easily with our free file encryptor. Our
              tools are here to help <br />
          ...
          <div className="flex items-center justify-between gap-10">
            <div>
              ...
              <p className="text-lg">
                ...
                from a variety of encryption shift to suit your needs. Our file
          ...
          <div className="flex flex-row-reverse items-center justify-between gap-10">
            <div>
              ...
              <p className="mb-4 text-lg">
                ...
                uses a unique key to scramble your data, making it unreadable to
            ...
            <div className="flex flex-col items-start justify-start gap-4 mt-8">
              ...
              <div className="border-b border-gray-600">
                ...
                <p className="text-lg mb-4">
                  ...
                  ensure your files are secure. We take your privacy seriously
                  and never store your files on our servers.
                </p>
              </div>
              <div className="border-b border-gray-600">
                <h3 className="text-xl font-bold font-heading text-white mb-2">
              ...
              <div className="border-b border-gray-600">
                ...
                <p className="text-lg mb-4">
                  Yes, our file encryptor is completely free to use. There are
                  no hidden fees or charges—just fast, secure encryption for
                  your files.
                </p>
              </div>
              <div className="border-b border-gray-600">
                ...
                <p className="text-lg mb-4">
                  ...
                  need to encrypt a small text file or a large PDF, we’ve got
                  you covered.
                </p>
              </div>
            </div>
