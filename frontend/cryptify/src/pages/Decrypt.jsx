...
const Decrypt = () => {
  ...
  const renderProcessFile = location.hash === "#r=decrypt";
      ...
      {renderProcessFile ? (
        ...
        <>
          <UploadFile
            ...
            navigation={"/decrypt#r=decrypt"}
          />
          <section className="mx-auto max-w-6xl px-4 text-lg">
            <div className="flex flex-col lg:flex-row items-start justify-between gap-8">
              <p className="max-w-2xl">
                Easily decrypt your files with Cryptify. Upload your encrypted
                file and get the decrypted file in seconds. Our decryption tool
                is simple, fast, and secure and doesn't add watermarks to your
                files.
              </p>
          ...
          <section className="mx-auto max-w-6xl px-4 text-lg mt-32">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
              ...
              <div className="flex flex-col items-center justify-center gap-2 text-center">
                ...
                <p>
                  Our decryption tool is fast and secure. We don't store your
                  files and don't add watermarks to your files.
                </p>
              </div>
              <div className="flex flex-col items-center justify-center gap-2 text-center">
                <div className="bg-gray-400 rounded-full w-10 h-10 text-center p-1">
                ...
                <p>
                  Simply drag and drop your files to get started. No need to
              ...
              <div className="flex flex-col items-center justify-center gap-2 text-center">
                ...
                <p>
                  Cryptify ensures secure decryption of your files. Your files
                  are safe with us.
                </p>
              </div>
              <div className="flex flex-col items-center justify-center gap-2 text-center">
              ...
              <div className="flex flex-col items-center justify-center gap-2 text-center">
                ...
                <p>
                  Cryptify has an easy-to-use interface. Simply upload your
              ...
              <div className="flex flex-col lg:flex-row items-center justify-center mt-8 gap-8">
                ...
                <div>
                  ...
                  <div className="flex flex-col items-start gap-3 text-lg">
                    <p>
                      1. Import or drag and drop your file to our decryption
                      tools
                    </p>
                    <p>2. Choose the number of shifts you want to use</p>
                    <p>
                      3. Click the “Decrypt Now” button to decrypt your file
                    </p>
